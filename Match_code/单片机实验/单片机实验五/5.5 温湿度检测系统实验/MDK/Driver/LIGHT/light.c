...
//ADC初始化------------------------------------------------------------------------------------------------------
void LIGHT_init(void)//ADC初始化  单通道 单次转换。
{
	GPIO_InitTypeDef GPIO_InitStructure;
	ADC_InitTypeDef ADC_InitStructure;
	

	RCC_APB2PeriphClockCmd(RCC_AHBxPeriph_LIGHT |RCC_APB2Periph_ADC1, ENABLE );	  //使能ADC1通道时钟
...
//ADC采集函数-------------------------------------------------------------------------------------------------
uint16_t Read_LIGHT(uint8_t ch)//通道采样1次
{
